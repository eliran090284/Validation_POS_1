SELECT c.bec_name,c.customer_planning_group,c.fiscal_week,c.weekid,b.weekid AS CURRENT_WEEKID,c.sum_quantity, b.weekid-c.weekid AS WEEK_GAP,
    SUM(c.sum_quantity) OVER(PARTITION BY c.bec_name,c.customer_planning_group ORDER BY c.weekid ROWS BETWEEN 13 PRECEDING AND 1 PRECEDING) AS SUM_quantity_bec_name,
    AVG(c.sum_quantity) OVER(PARTITION BY c.bec_name,c.customer_planning_group ORDER BY c.weekid ROWS BETWEEN 13 PRECEDING AND 1 PRECEDING) AS AVG_quantity_bec_name,
